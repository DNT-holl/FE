...
public interface BookedSeatRepo extends JpaRepository<BookedSeat, Long> {
    ...
    // Tìm một ghế cụ thể theo tiêu đề phim, thời gian, ngày, và số ghế
    BookedSeat findBySeatNoAndMovieTitleAndTimeAndDate(int seatNo, String movieTitle, String time, String date);

    // Xóa một đối tượng BookedSeat
    void delete(BookedSeat bookedSeat);
